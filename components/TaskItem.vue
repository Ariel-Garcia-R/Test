...
<template>
  ...
  >
    ...
    <div
      ...
      class="min-w-24 flex items-center justify-center transition-all ease-out h-full absolute right-0 bg-gradient-to-r from-transparent to-white dark:to-slate-900"
